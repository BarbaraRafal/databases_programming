# Przy pomocy connection
from exercises2.ex2 import engine, Directors, Movies
...
insert_movies_query = insert(Movies)
insert_directors_query = insert(Directors)
conn.execute(insert_movies_query, movies)
conn.execute(insert_directors_query, directors)
conn.close()
